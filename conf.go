...
type Conf struct {
	...
	OneNamespaceMode bool     `json:"oneNamespaceMode,omitempty"` // by qiwen698
	TagName          string   `json:"tagname,omitempty"`          // by qiwen698
	EnableLocalCache bool     `json:"enable_local_cache"`         // by qiwen698
